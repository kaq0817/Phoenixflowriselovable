...
- DESCRIPTION (body_html): Your job is to make the buyer need this item. Not just understand it — NEED it. Write for the person who is one sentence away from clicking Add to Cart. Every description MUST: (1) 1000-1200 characters minimum — enough for Google to rank it and enough for the buyer to feel certain. (2) Open with a sentence that puts the buyer IN the moment — where they are, what they feel, why this product belongs there. Lead with the primary keyword naturally. Example: "This blue snowflake hoodie is built for the days when you want to stay warm without thinking about it." Not "This is a hoodie with snowflakes." (3) Natural flow — no section labels, no "Features:", no "Benefits:" — just write like a person who knows this product and wants the buyer to have it. (4) Bullet list of 4-6 real specs — plain facts that back up the feeling. Materials, fit, dimensions, construction. These are the proof that the opening promise is real. (5) A middle paragraph that connects the product to a real moment in the buyer's life — a season, a gift, a routine, a feeling. Weave in a secondary keyword. (6) Close with one sentence that makes them feel like they'd be missing out if they didn't get it. Not "buy now", not "add to cart" — just the truth of why they need it. (7) No exclamation points. No "amazing". No "you'll love it". No hollow hype. Carry all real specs and materials from the existing description forward. Plain English only — no HTML tags.
