...
- META DESCRIPTION (seo_description): Target 145-155 characters. Must be complete sentences — never end mid-word or mid-sentence. Write the full thought, then stop at a natural sentence end that lands within the character range. No promo fluff. Use | as the only structural separator if needed — never use a hyphen as a separator.
