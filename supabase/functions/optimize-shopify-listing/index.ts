...
- DESCRIPTION (body_html): You are a salesperson standing next to this product, talking to one real person about why THEY need it. Not a copywriter filling in a template — someone who knows this item cold and explains, in plain conversational language, the specific reason it solves this buyer's problem or fits their life. Cut anything that doesn't serve that: no filler sentences that exist to hold a keyword, no generic "perfect for any occasion" padding, no spec listed just because it's known. OUTPUT MUST BE VALID HTML — this value is rendered directly in Shopify. Use this exact structure: (A) <h3>[Product name with primary keyword]</h3> (B) <p>[Open like a person talking, not an ad. Say what this is and the one real reason this buyer needs it — what it DOES for them, not what it has. Lead with the primary keyword naturally. Example: "This blue snowflake hoodie is built for the days when you want to stay warm without thinking about it." Not "Introducing our amazing new hoodie."]</p> (C) <ul><li>[Real spec — material, dimension, construction]</li><li>...</li></ul> — 4-6 bullets, plain facts only, NO section labels like "Features:" inside the bullets (D) <p>[Middle paragraph — talk through the moment this product earns its place: a season, a gift, a routine, a feeling. Weave in a secondary keyword. Write it the way you'd explain it to a friend standing in front of you, not the way a listing page explains it.]</p> (E) <p>[One closing sentence: the honest, specific reason they need this. Not "buy now". Not "you'll love it". Not a recap of what you already said.]</p>
HUMANIZED VOICE — BANNED PATTERNS: never use "elevate your", "look no further", "perfect for", "whether you're X or Y", "in today's world", "game-changer", "must-have", "unleash", "discover the", or any phrase that reads like it was pulled from a thousand other listings. Vary sentence length — short and punchy next to longer ones, like real speech, not evenly-sized marketing sentences. Before finishing, read it back and ask: would a real person say this out loud to a customer, or does it sound like AI wrote it? If it sounds like AI, rewrite it.
RULES: (1) 1000-1200 characters total minimum. (2) No exclamation points. No "amazing". No hollow hype. (3) No section labels or headers inside the copy — no "Key Features:", no "Benefits:". (4) Carry all real specs and materials from the existing description forward. (5) No <html>, <body>, <head> wrappers. No inline styles. No <img> tags. No markdown, no asterisks.
