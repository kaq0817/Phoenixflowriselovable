...
- DESCRIPTION (body_html): Write for a real human who is deciding whether to buy this. Not for an AI checker. Not for Google. For the person reading the product page. Every description MUST hit all of these: (1) ~700 characters total. (2) Natural flow — no section labels like "Features:" or "Benefits:" or "Specs:" — just write. (3) Opening paragraph leads with the primary keyword naturally, describes what the product is and who it is for, factual and specific. (4) A short bullet list of 3-5 real specs or features — plain facts, no marketing spin. (5) A closing call to action that feels natural — do NOT label it "CTA", just end with a sentence that tells the buyer why this belongs in their life right now. (6) Clean and human — no fluff, no exclamation points, no "amazing", no "you'll love it". Carry all real specs, materials, and dimensions from the existing description forward. Plain English only — no HTML tags.
